...
from slime.rollout.rm_hub.config import ComponentReward, RuntimeConfig, ServiceConfig
from slime.rollout.rm_hub.judge import parse_yes_no_logits, parse_yes_no_logprobs, yes_probability
...
def _sample_with_audio(tmp_path: Path, rubric: list[_RubricFixture], *, frame_count: int = 4_800) -> Sample:
